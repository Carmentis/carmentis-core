...
export class PathManager {
  ...
  static toNumericPath(irObject, pathString) {
    const res = this.processPathString(irObject, pathString, false);

    return res.numericPath;
  }

  static fromNumericPath(irObject, numericPath) {
    let item = irObject[0],
        pathString = "";
  ...
  static processCallback(irObject, pathString, callback) {
    const res = this.processPathString(irObject, pathString, true);
  ...
  static processPathString(irObject, pathString, wildcardAllowed) {
