...
export class Utils {
  static numberToHexa(value, size) {
    return value.toString(16).toUpperCase().padStart(size || 1, "0");
  }

  static binaryToHexa(array) {
  ...
  static intToByteArray(n, size = 1) {
    const arr = [];
