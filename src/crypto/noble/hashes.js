...
export var hmac = (hash2, key, message) => new HMAC(hash2, key).update(message).digest();
...
export var hkdf = (hash2, ikm, salt, info, length) => expand(hash2, extract(hash2, ikm, salt), info, length);
...
export async function pbkdf2Async(hash2, password, salt, opts) {
...
export var sha256 = /* @__PURE__ */ wrapConstructor(() => new SHA256());
export var sha224 = /* @__PURE__ */ wrapConstructor(() => new SHA224());
